...
INSERT INTO jpa_assignment.recipe_ingredient(recipe_ingredient.id,amount, measurement, ingredient_id, recipe_id)VALUES(40,20, 2, 7, 30);
INSERT INTO jpa_assignment.recipe_ingredient(recipe_ingredient.id, amount, measurement, ingredient_id, recipe_id)VALUES (42, 25, 2, 5, 31);
INSERT INTO jpa_assignment.recipe_ingredient(recipe_ingredient.id, amount, measurement, ingredient_id, recipe_id)VALUES (43, 32, 3, 6, 31);
INSERT INTO jpa_assignment.recipe_ingredient(recipe_ingredient.id, amount, measurement, ingredient_id, recipe_id)VALUES (44, 28, 4, 4, 32);
INSERT INTO jpa_assignment.recipe_ingredient(recipe_ingredient.id, amount, measurement, ingredient_id, recipe_id)VALUES (45, 33, 5, 4, 33);
INSERT INTO jpa_assignment.recipe_ingredient(recipe_ingredient.id, amount, measurement, ingredient_id, recipe_id)VALUES (46, 12, 4, 1, 30);
INSERT INTO jpa_assignment.recipe_ingredient(recipe_ingredient.id, amount, measurement, ingredient_id, recipe_id)VALUES (47, 32, 1, 3, 32);
